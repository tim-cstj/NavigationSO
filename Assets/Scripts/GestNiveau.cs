...
public class GestNiveau : MonoBehaviour
{
    ...
    [Header("Données et interfaces")] //Entete de section pour les données et l'interface
    ...
    void Awake()
    {
        ...
        if(_instance==null) _instance = this; //condition habituelle du Singleton
        else
        {
            Destroy(gameObject); //detruire
            Debug.LogWarning("Destruction d'une instance superflue du Singleton GestNiveau");
